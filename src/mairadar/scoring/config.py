...
# P99.9 for its upper anchor so the Top-5 tail does not saturate at P99.
# None is official.
FEATURE_MAPPERS = {
    ...
    "slide_tricky": DummyPnMapper(p50=0.11, p100=0.52),
...
class DefaultScoreTransformer(FeatureScoreTransformer):
    def __init__(self):
        super().__init__(
            FEATURE_MAPPERS,
            mapping_version="provisional-slide-onset-log20-20260914-v18",
        )
