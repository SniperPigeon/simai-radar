...
# P99.9 for its upper anchor so unique high groups do not saturate at P99.
# None is official.
FEATURE_MAPPERS = {
    ...
    "slide_tricky": DummyPnMapper(p50=0.135, p100=0.54),
    "slide_cumulate": DummyPnMapper(p50=0.46, p100=1.23),
...
class DefaultScoreTransformer(FeatureScoreTransformer):
    def __init__(self):
        super().__init__(
            FEATURE_MAPPERS,
            mapping_version="provisional-slide-cumulate-20260914-v21",
        )
