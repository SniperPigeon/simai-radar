...
# P99.9 for its upper anchor so supported high groups do not saturate at P99.
# None is official.
FEATURE_MAPPERS = {
    ...
    "slide_tricky": DummyPnMapper(p50=0.098, p100=0.43),
...
class DefaultScoreTransformer(FeatureScoreTransformer):
    def __init__(self):
        super().__init__(
            FEATURE_MAPPERS,
            mapping_version="provisional-slide-supported-max-20260914-v19",
        )
